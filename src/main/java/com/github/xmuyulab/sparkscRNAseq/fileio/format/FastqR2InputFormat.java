...
public class FastqR2InputFormat extends FileInputFormat<Text,Text> {
  ...
  public static class FastqR2RecordReader extends RecordReader<Text,Text>{
    ...
    public Text getCurrentKey(){
      return new Text(currentValue1.toString().substring(0, currentValue1.toString().length()-1));
    }
